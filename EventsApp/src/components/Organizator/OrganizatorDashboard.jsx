...
const OrganizerDashboard = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-md shadow-md mt-6">
      ...
      <div className="flex justify-center space-x-6">
       {/* Link pentru adăugarea unui grup de evenimente */}
        <Link
           to="/organizer/addEventGroup"
           className="px-6 py-3"
           style={{
         ...
         {/* Link pentru vizualizarea grupurilor */}
         <Link
          to="/organizer/getEventGroupList"
          className="px-6 py-3"
          style={{
            backgroundColor: "#2471A3", 
            color: "white",
          ...
          onMouseOver={(e) => (e.target.style.backgroundColor = "#30C1B8")} 
          onMouseOut={(e) => (e.target.style.backgroundColor = "#2471A3")}
        >
          Vizualizează Grupuri Evenimente
        </Link>
      </div>
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Statistici Evenimente</h2>
        <ul className="text-gray-600">
          <li>- Număr total de grupuri de evenimente: <strong>5</strong></li>
          <li>- Număr total de evenimente organizate: <strong>10</strong></li>
          <li>- Număr de participanți înscriși: <strong>120</strong></li>
        </ul>
      </div>
